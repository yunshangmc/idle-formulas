const evilActions = [
  ...
  },
  {
    ...
    durationSeconds: 10,
    headerText: (
      <>The World formula has absorbed enough evil energy to be enhanced!</>
    ),
  },
  {
  ...
  },
  {
    ...
    headerText: (
      <>
        Your Hirees are dead! Even the World Formula is disgusted by your
        Actions and refuses to help.
        <br />
        <br />
        You will have to finish this completely on your own.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    quoteText: (
      <>
        &ldquo;It is a man’s own mind, not his enemy or foe, that lures him to
        evil ways.&rdquo;
      </>
    ),
...
const goodActions = [
  ...
  },
  {
    ...
    durationSeconds: 10,
    headerText: (
      <>The World formula has absorbed enough good energy to be enhanced!</>
    ),
  },
  {
    title: "CURE HALF",
  ...
  },
  {
    ...
    headerText: (
      <>
        Those last Illnesses are really tough. Neither your hirees nor the World
        Formula are able to cure them! <br />
        <br />
        You will have to finish this completely on your own.
      </>
    ),
  ...
  },
  {
    ...
    quoteText: (
      <>
        &ldquo;You don't need to save the world.
        <br />
        You just need to save one person.
        <br />
        And it is okay if that person is you.&rdquo;
      </>
    ),
...
const trueActions = [
  ...
  },
  {
    ...
    repeat: 9,
    headerText: (
      <>You can feed your incremental energy into the World Formula!</>
    ),
  },
  {
    title: "ENHANCE WORLD FORMULA",
    ...
    headerText: (
      <>
        The World formula has absorbed enough incremental energy to be enhanced!
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    headerText: (
      <>
        The World formula is at maximum power!
        <br />
        <br />
        You found inner peace!
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    teaseHeaderText: <>~???? ??????~</>,
    quoteText: (
      <>&ldquo;Incremental progress leads to long-lasting results.&rdquo;</>
    ),
...
export const endingList = {
    ...
    actions: [
      {
        ...
        storyText: (
          <>
            Who cares about the story anyway.
            <br />
            You just finished World Formula Any%!
          </>
        ),
        final: true,
        endingName: "skipped",
  ...
  logarithm: {
    titlestring: "Depressed Logarithm",
    actions: [
      {
        ...
        storyText: (
          <>
            That poor logarithm was in need of some positivity.
            <br />
    ...
    actions: [
      {
        ...
        storyText: (
          <>
            As you venture into the depths below Negative Space, you find
            yourself trapped in Negative Hell.
            <br />
  ...
  divide: {
    titlestring: "The not so Great Divide",
    actions: [
      {
    ...
    actions: [
      {
        ...
        storyText: (
          <>
            This game cannot handle roots of negative numbers.
            <br />
            So I need to leave the rest of this story to your imagination.
          </>
        ),
        final: true,
    ...
    actions: [
      {
        ...
        storyText: (
          <>
            There are infinitely many things that can go wrong when doing maths.
            <br />
            Be more careful next time!.
          </>
        ),
    ...
    actions: [
      {
        ...
        storyText: (
          <>
            Sometimes, when things are not working out favorably, it is best to
            quit early.
            <br />
            Instead of wasting time like you just did.
          </>
        ),
        final: true,
        endingName: "timeout",
