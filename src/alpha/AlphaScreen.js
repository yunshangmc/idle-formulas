    ...
    <div style={{ color: "#ff7777" }}>
      {
        ...
        >
          &alpha;&nbsp;=&nbsp;
          {formatNumber(state.alpha, state.settings.numberFormat, 3)}
        </h3>
      }
      <button
        style={{ marginLeft: "20px" }}
        onClick={() => setAlphaTab("AlphaUpgradeTab")}
      >
        Upgrades
      </button>
      &nbsp;
      {state.mailsCompleted["Research"] !== undefined && (
        <>
          <button onClick={() => setAlphaTab("AlphaResearchTab")}>
            Research
          </button>
          &nbsp;
        </>
