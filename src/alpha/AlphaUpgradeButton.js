export default function AlphaUpgradeButton({
  state,
  popup,
  upgrade,
  updateState,
  ...
  return (
    <button
      title={disabled ? undefined : upgrade.description}
      disabled={disabled}
      onClick={clickAlphaUpgrade}
      style={buttonStyle}
    >
      {upgrade.title}
      <br />
