...
export const startingStones = {
  ...
  Timewall: {
    ...
    title: "Timewall ",
    description: (
      <>&alpha;-Reset while having at least four billion Alpha and x=1e110</>
    ),
  ...
  AllUpgrades: {
    ...
    check: (state) =>
      countAlphaUpgrades(state) >= 12 &&
      state.autoApplyLevel >= 2 &&
      state.baseAlphaLevel >= 12,
  },
};

export const stoneTable = [
  ["BadEndings", "WorldFormula", "VeryAlpha"],
  ["AllChallenges", "Timewall", "Googol"],
  ["MaxResearch", "StartingValue", "AllUpgrades"],
];
