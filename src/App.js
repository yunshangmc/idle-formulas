...
function App() {
  ...
  return (
    <>
      ...
      {state.settings.headerDisplay === "VERTICAL" && (
        <div
          style={{
            fontSize: "24px",
            fontWeight: "bold",
      ...
      {state.settings.headerDisplay === "HORIZONTAL" && (
        <div
          style={{
            fontSize: "24px",
            fontWeight: "bold",
      ...
      {state.settings.headerDisplay === "X" && (
        <h1
          style={{
            fontSize: "40px",
            marginLeft: "20px",
      ...
      {state.settings.headerDisplay === "ALPHA" && (
        <h1
          style={{
            fontSize: "40px",
            marginLeft: "20px",
      ...
      {state.settings.headerDisplay === "STARS" && (
        <h1
          style={{
            fontSize: "40px",
            marginLeft: "20px",
      ...
      {state.settings.headerDisplay === "STARLIGHT" && (
        <h1
          style={{
            fontSize: "40px",
            marginLeft: "20px",
      ...
      <footer>
        <span style={{ display: "inline-block" }}>
          <button
            ...
            onClick={() => selectTab("FormulaScreen")}
          >
            Formulas
          </button>
          {state.progressionLayer >= 1 && (
            <button
              ...
              onClick={() => selectTab("AlphaScreen")}
            >
              Alpha
            </button>
          )}
          {(state.progressionLayer >= 2 || state.destinyStars > 0) && (
            <button
              style={{
              ...
              onClick={() => selectTab("DestinyScreen")}
            >
              Destiny
            </button>
          )}
        ...
        <span style={{ display: "inline-block" }}>
          <button
            style={{ margin: "5px" }}
            onClick={() => selectTab("AchievementScreen")}
          >
            Milestones
          </button>
          {state.mailsList.length > 0 && (
            <button
              style={{
                margin: "5px",
                fontWeight: hasNewMail ? "700" : undefined,
                background: hasNewMail ? "#FFAA66" : undefined,
              }}
              onClick={() => selectTab("MailScreen")}
            >
              Mails
            </button>
          )}
          <button
            style={{ margin: "5px" }}
            onClick={() => selectTab("OptionScreen")}
          >
            Options
          </button>
        </span>
